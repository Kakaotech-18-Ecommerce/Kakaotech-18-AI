...
from category_based_recommendation import get_category_recommendations
...
def main():
    ...
    # 카테고리별 추천 (출력 대신 반환된 추천 결과를 활용)
    category_recommendations = get_category_recommendations(filtered_data, label_encoder)
...
if __name__ == "__main__":
    main()
    print("Completion of model training results and recommendation scores")
